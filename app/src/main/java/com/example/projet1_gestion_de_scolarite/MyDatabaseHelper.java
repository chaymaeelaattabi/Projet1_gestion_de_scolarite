...
public class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "project_1.db";
    private static final int DATABASE_VERSION = 1;

    private static final String TABLE_NAME_LOGIN ="registeruser";
    ...
    public void onCreate(SQLiteDatabase db) {
        String query = "CREATE TABLE " + TABLE_NAME_LOGIN  +
                " (" + COL_1 + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                COL_2 + " TEXT NOT NULL," +
                COL_3 + " TEXT NOT NULL"+ ");";

        String query1 = "CREATE TABLE " + TABLE_NAME_MODULE +
    ...
    void addModule(String module_name){
        ...
        if (result == -1){
            Toast.makeText(context, "Failed to insert Module", Toast.LENGTH_SHORT).show();
        }else{
            Toast.makeText(context, "Module inserted successfully", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    void addFiliere(String filiere_name){
        ...
        if (result == -1){
            Toast.makeText(context, "Failed to insert Filiere", Toast.LENGTH_SHORT).show();
        }else{
            Toast.makeText(context, "Filiere inserted successfully", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    void addStudent(String student_cne, String student_name, String student_last_name, String student_filiere_name){
        ...
        if (result == -1){
            Toast.makeText(context, "Failed to insert Student", Toast.LENGTH_SHORT).show();
        }else{
    ...
    public boolean checkUser(String user, String pass){
        ...
        Cursor cursor = sqLiteDatabase.query(TABLE_NAME_LOGIN,columns,selection,selectionArgs,null,null,null);
