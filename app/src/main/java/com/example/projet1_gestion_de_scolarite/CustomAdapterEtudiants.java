...
public class CustomAdapterEtudiants extends RecyclerView.Adapter<CustomAdapterEtudiants.MyViewHolder> {

    private Context context;
    private ArrayList<String> student_cne, student_name1, student_name2, student_filiere;


    CustomAdapterEtudiants(Context context, ArrayList student_cne, ArrayList student_name1, ArrayList student_name2, ArrayList student_filiere){
    ...
    @NonNull
    @Override
    public CustomAdapterEtudiants.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.etudiants_f, parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CustomAdapterEtudiants.MyViewHolder holder, int position) {
